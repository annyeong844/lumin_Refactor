...
Status: provenance closure candidate pending independent review; numeric-target gate pending
...
| Externally reviewed static-packaging evidence candidate | `e0a2810b46f6091895b5e9f7dd4454e8854fee0e`; exact Git/architecture/65-entry packet/9-entry source binding and the standalone boundary passed, native Linux passed through external workflow provenance, and Windows/WSL plus detached-artifact authorization were REOPENED by NEW-STATIC-PACKAGING-01 |
...
| Clean-provenance closure candidate | `658b5c7334fed8f0e42dd14b9910c9b719f3e55b`; exact-bound v2 fetch/host/result/workflow verification, regenerated clean evidence, and resealed negative controls are author-verified only; external closure review pending |
...
| Static-packaging candidate manifest/review | packet `b1c685a535a5c5e36011de7b59fd89d8400a29d0b5d06db874b629c6e8180ed7`, source `dd30eeda67caf9e354838a9ec7974cdd3dc118a9136c2556fcfe56c9f441db45`; independent report `b26cee869f883ec6ba1b776a46f53d276ce3c39cb1333865a050c31490c27ac0` |
| Static-packaging independent checks | `128/132` passed; the four failed checks are facets of NEW-STATIC-PACKAGING-01. Checker `7249d5faf98a9d025a4fa10c25923b6e9906bee55a7f54a078e45ab3108328b9`, result `59e6dcd79cc3f5506c410644b3c5efcd76ba7f0917d0c6793960d45fd0fac207`, substitution evidence `fe7dc2f027440ab2faf393c783483d88144a8a575c3bcf08c2a453f833135c2f` |
| Static-packaging closure manifests/review | packet `ad2e746441ee778ecf8e8f51a12a331d3c6b3c78a1c995fb661970ab925b6764`, source `38c1a75d06edb12bb2798d93bc1ce788325ca33c6bc12dabd4ef10df943b677c`; independent report `db4648ab8749e96755644033c297236b8ecabcac8b68958fc2b65a768753ef58` |
| Static-packaging closure transport and bundle | ZIP `653d7022c7030630dcb51e715d59c264bcd4d106d2a36fbf381be1c141a174df`; complete-history bundle `8c9f00f01ccfcedb264d9556a7bc29c553412f67ba5074d0be73927c9830c465`; handoff HEAD `86c97ebb4c5323acfafb3237b6774e89287be798` |
| Static-packaging closure independent checks | `202/202` machine checks and `6/6` concrete adversarial scenarios passed. Dynamic `/bin/true`, a one-byte-changed artifact with identical smoke output, stale run evidence, changed-artifact/retained-run composition, and embedded source-identity tampering were rejected; author `69/69` remained consistency-only |
| Clean-provenance candidate manifests/review | packet `77f9790453b7ebad9ba4ba5856f8d6de40bf971f43ec40c899d19fa272762482`, source `0f39d6782d79e980e128a7a70ed316ac0cae314d9e2812bec8e6825422406b92`, evidence `2228b0ac40afe62d4d72c12919e7dae1a8d1c8a6921f507c6ea6790e56dfc28f`; independent report `6826af8f1d578f3a423ae3725be1c3fb254a00e373ff2db4df7e2d4fc9537aaa` |
| Clean-provenance independent checks | `200/200` assertions passed, including reproduction of two false-PASS paths: resealed `302`/redirect/gzip fetch metadata and forged host/repository/GITHUB_SHA identity. Reviewed handoff transport ZIP `81ad62d08e134219977b64b4ef96bfd86ea4f81ddbb53432254b172da7f37fbf` |
| Clean-provenance closure author evidence | packet `cc887e448e2a560801c09cd082f55304f689148a74d6f91e837582de70df65a3`, source `14185a4c6c74cac84283b89ce2002f4da8c4afb44f50e5f21e2f236aa299d7f3`, evidence `439eff660625b3792c9c6438be6d063a94dce07f6a40802b2368a962e0509b68`; clean run `29642350675`, runner `7e6ebd097cd69318669494fbd95acecbf627b5b4`, artifact `8428995583`, archive `4688a9a192349efe7114fc823474732797ee6ee1f3cf49301056a101dc6857c9`; external verdict pending |

The first report verified the exact first amended revision. Several later reports verified supplied byte manifests but could not bind loose uploads to their declared Git commits. Exact-tree reports subsequently passed B-07 for `491f478`, `d7e96b0`, and `65e6021`, each only for its own named revision. The independent freeze report for `65e6021` excluded Author-Side Preflight from PASS evidence, reproduced all 16 Git-object bindings and the manifest, passed 239 machine checks, found no REOPEN/NEW item, and closed NEW-H10-01/NEW-H11-01. The superseded `58b1060` backend amendment never reached external review: exact-checkout verification exposed its incomplete evidence tree. The external report for replacement `579c235` passed its semantic amendment and canonical evidence but reopened that exact SHA for the separate stale-seal finding NEW-EVIDENCE-01. Exact candidate `b8ff840` deletes only that competing seal; the independent closure report passed B-07, closed NEW-EVIDENCE-01, preserved the 16 owner blobs and all 168 path-addressed evidence bindings, and found no regression or new finding. The exact-tree report for `9a0dbe5` then passed B-07, closed NEW-PHASE-GATE-01 and its F-12 predecessor, preserved all 38 acceptance criteria, 38 traceability rows, 22 Product ACs, and six distribution requirements, and found no H/R regression or new finding. The static-packaging report for `e0a2810` passed exact Git and packet binding, the standalone boundary, and native Linux workflow provenance, but reproduced a false PASS by substituting dynamic `/bin/true` for both GNU and musl artifacts while retaining stale run/linkage evidence. It therefore reopened the Windows/WSL and detached-artifact portions under NEW-STATIC-PACKAGING-01 without reopening any H/R contract. Exact closure candidate `4315eb7` binds one artifact byte sequence through hashing, direct PE/ELF inspection, a fresh execution copy, run-v2 source/architecture identity, post-execution hashing, retained evidence, and detached verification. Its independent report passed all platform scopes, `202/202` checks and six concrete attacks, closed NEW-STATIC-PACKAGING-01 without accepted risk, and found no H/R regression or new finding. The clean-provenance report for `e6147b1` independently passed every retained upstream byte and derivation but resealed false `302`/redirect/gzip metadata and a forged clean-runner identity without rejection. It opened NEW-PROVENANCE-01 without reopening an H/R contract. Exact candidate `658b5c7` is the author-side closure candidate and has no external disposition yet.
...
| B-07 exact review identity | External PASS for `4315eb7` | The static-packaging closure reviewer addressed exact candidate `4315eb7dee35fff3de40fb04e1dd3c4a3fc990e3`, reproduced architecture manifest SHA-256 `e2ca379a8a659f2febbc4e277c89db67bb02035a6b10467cf78a5663f21cd99a`, and bound all 16 owner blobs, including both Korean canonical sources and all three strict-parsed machine artifacts. This PASS is revision-specific. |
...
| NEW-PROVENANCE-01 detached fetch/runner semantic binding | External REOPEN for `e6147b1`; closure candidate `658b5c7` pending | The external reviewer proved that the v1 verifier accepted resealed `302`/redirect/gzip fetch metadata and forged platform/repositoryHead/GITHUB_SHA values. Candidate `658b5c7` derives all eight fetch IDs/URLs/paths from frozen owners and the retained Node tag ref, binds status/final URL/encoding/length/hash to retained bytes, binds host/GITHUB_SHA/result runner/workflow head to one exact runner, and adds nine built-in plus nine resealed controls. These are author-side facts until an independent exact-object closure report passes them. |

Historical `Accept finding` entries record architecture-authoring decisions and were never treated as independent PASS evidence. Document/design findings above come from the exact-tree report for `65e6021`; backend, evidence-closure, phase-boundary, and static-packaging decisions additionally come from the exact-tree reports for `579c235`, `b8ff840`, `9a0dbe5`, and `4315eb7`. NEW-PROVENANCE-01 remains open until candidate `658b5c7` receives an independent closure PASS.
...
### Phase-gate-boundary amendment candidate

The exact author-side amendment candidate is Git commit
`9a0dbe5c89463892c001e864c4f18eeab9e0eaed`, commit message
`Separate Phase 0 feasibility from Phase 1 acceptance`, with parent
`085828ef09d5eb43621ae992001974ff637a3db2`. Its semantic diff changes only
`WORKBOARD.md` and `specs/001-foundation-slice.md`. This ledger is a later commit and
is not part of the candidate manifest.

The candidate restores the Phase 0/Phase 1 distinction already required by REVIEW-001
F-12. Phase 0 may use standalone, non-production harnesses for architecture/static
packaging feasibility and target approval, but cannot require a public `lumin` binary,
DTO, packaged skill adapter, process behavior, or achieved product budget before Phase 1
begins. All those product proofs remain unchanged in SLICE-001 as Phase 1 exit criteria.

The exact 16-file manifest SHA-256 is:
...
18326ce8d50fd7154755912533d77e8ff987c8da48a104fc7244c24a13b8c139  README.md
2e540685f83e0ea730e1260de25649d379a142d685adce0eb5c8ea5ea45de36f  SDD.md
c8295b8be20ebceb7ea57e5d7931927a46aa4ac7edd1c2c57894ca6c4583fcdb  WORKBOARD.md
e505a30758d5033d837f8cc95719ec1499b7d4d182704a51c98d0910c8473921  architecture/000-system-blueprint.md
9ab1c72019dc6519a21c02238c6a1d6c57e35018a10ed3842c6e6eae10b632ec  architecture/001-execution-and-ownership.md
6de31addb2319b44c0cdf81c54c5e4711c5d0f0e844d71b2b37245069528a4e7  architecture/002-evidence-and-write-gate.md
ad204a0769530c942f62cdd5d7160e73e391608bab6604ad3ccce7b368555518  specs/000-product-contract.md
afe727315ef42ca50f72181749f1099fc33668cbd4dac7ae1feb123a754fc440  specs/001-foundation-slice.md
ebca37c3b33f8e4d92ea29e0bcdc51b7cd5ea04a453c4c469a89072f3d2fac02  specs/inventory-config-semantics.v1.json
ee686f81164ff40b281483afaae591793964cc576afaca0ce7b5b51a6798b4a6  specs/repo-path-semantics.v1.json
41ffa3dcc108e74dca351b4f3a5fa182090e1481ed6d8333235f38f0459a29a1  specs/resolver-config-semantics.v1.json
17dbece96b064d83ad39d905bf044e17286a3e813106b21fd50f6b1d00728e15  문서(한글)/AGENTS.ko.md
...
No author-side calculation above is independent PASS evidence. The reviewer must bind
the exact commit, reproduce the manifest, verify the two-file semantic diff, and decide
...
verified all 20 newly preserved raw build logs. The later independent closure report
repeated the exact-object checks for `b8ff840`, passed `34/34` independent checks,
confirmed all 168 unique target paths and 20 nonempty logs, and found zero canonical
evidence-byte changes or competing packet-wide seals. Byte-identical targets may share
Git object IDs; 168 is the path-addressed binding count, not a claim of 168 distinct
content OIDs.
...
The previous remaining-gate list required actual Windows/Linux product packages,
packaged skill adapters, native product path/root DTO round trips, and public process
behavior before Phase 1 implementation could start. SLICE-001 simultaneously required
Phase 0 probes to remain standalone, non-production harnesses that expose no product API
and create no production scaffold. Both requirements cannot be satisfied in sequence:
the evidence needs the Phase 1 product whose implementation the evidence was blocking.

Candidate `9a0dbe5` changes timing ownership, not product scope. Phase 0 retains only
proof available without production implementation: standalone architecture/backend/OXC
feasibility and selection, static target/linker/artifact/dependency packaging
...
and closed NEW-STATIC-PACKAGING-01. Clean-provenance candidate `e6147b1` was reopened by
NEW-PROVENANCE-01; exact closure candidate `658b5c7` is awaiting independent review. The
remaining Phase 0 blockers are limited to
...
1. Close NEW-PROVENANCE-01 by independently verifying exact candidate `658b5c7`, its exact fetch/retained-byte and clean-runner/workflow binding, and its resealed negative controls. Phase 1 architecture-check must later enforce the same pinned identities.
2. Approve numeric Phase 1 target budgets for time, peak RSS, worker stack, default jobs, and binary size from the named Phase 0 probe evidence, keeping the `/mnt/<drive>` diagnostic separate as specified. These are targets, not achieved-product claims.

The following remain mandatory but are Phase 1 exit criteria, not Phase 0 freeze gates:

- actual Windows/Linux prebuilt `lumin` packages and runtime-without-Cargo behavior;
- Unix raw-byte and Windows WTF-16/UNC/volume-root round trips through the product binary and canonical DTOs;
- packaged Codex/Claude adapters using the same public binary/DTO contract;
