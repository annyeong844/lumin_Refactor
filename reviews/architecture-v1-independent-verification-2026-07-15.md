...
| Clean-provenance closure manifests/review | B-07 `ca46f77997c696f8eeefc2feabdb9c1031a6e58e36fcb6f2a7ed4ad1bca84fcd`, frozen architecture `e2ca379a8a659f2febbc4e277c89db67bb02035a6b10467cf78a5663f21cd99a`, packet `cc887e448e2a560801c09cd082f55304f689148a74d6f91e837582de70df65a3`, source `14185a4c6c74cac84283b89ce2002f4da8c4afb44f50e5f21e2f236aa299d7f3`, evidence `439eff660625b3792c9c6438be6d063a94dce07f6a40802b2368a962e0509b68`; independent report `4894a45bbd4ea6b54447fb206e889b8f34e69e7a7fb737506cdce2cb0bcc3526` |
| Clean-provenance closure workflow/artifact | run `29642350675`, job `88074824267`, runner `7e6ebd097cd69318669494fbd95acecbf627b5b4`, artifact `8428995583`, archive `4688a9a192349efe7114fc823474732797ee6ee1f3cf49301056a101dc6857c9` / 6,257,298 bytes; official API and fresh download matched retained evidence |
| Clean-provenance closure transport and bundle | ZIP `9344160b78c2d3e5c68739f43191ae563426c64c94c2c22ffc15dfa9d623828c`; complete-history bundle `f184c4cf9f4d28f9ef025c8d15dbfa2d60ac2f3f98be10ccb0010f56fd6eaa8c`; handoff HEAD `12da1a1984483d65b6110f8049814fefb1326e8b` |
...
| B-07 exact review identity | External PASS for `a1e07ed` | The false-negative amendment reviewer addressed exact candidate `a1e07ed7b9e05181cd58bfba5f3846c1baab8a93`, reproduced candidate manifest SHA-256 `8b0d2ceddb930533e6967c48e06954f09f53abf8f7a688f4dfb0baeb050a6339`, and bound all 16 owner blobs, including both Korean canonical sources and all three strict-parsed machine artifacts. This PASS is revision-specific. |
...
| NEW-FALSE-NEGATIVE-01 canonical finding suppression | External PASS — CLOSED for `a1e07ed` | The independent reviewer reproduced the legacy `recordExcluded`/`MUTED`/SARIF omission path and verified that the candidate does not merely rename it. Every grounded generated/vendor row remains canonical, counted, cursor-addressable, and present in the unfiltered default query and projections; explicit normalized filters disclose `scopeTotal` and matched `total`; `FindingDisposition` changes remediation only; disposition changes are payload changes rather than resolution; and muted or reduced-result benchmark samples are invalid. The review passed `210/210` checks with no H/R regression, prior-gate regression, accepted risk, or new finding. |

Historical `Accept finding` entries record architecture-authoring decisions and were never treated as independent PASS evidence. Document/design findings above come from the exact-tree report for `65e6021`; backend, evidence-closure, phase-boundary, static-packaging, clean-provenance, and false-negative decisions additionally come from the exact-tree reports for `579c235`, `b8ff840`, `9a0dbe5`, `4315eb7`, `658b5c7`, and `a1e07ed`. NEW-PROVENANCE-01 and NEW-FALSE-NEGATIVE-01 are closed.

### GitHub provenance trust boundary

GitHub's official commit, Actions API, job, and artifact services are the external trust
root for this Phase 0 provenance evidence. The detached verifier proves retained-byte
integrity and internal consistency; it does not claim to cryptographically authenticate
GitHub. Independent review therefore performs one official-service lookup and fresh
artifact comparison. A coherently forged GitHub response is a compromise of the named
external trust root, not a product behavior that Lumin reimplements.

The standalone provenance packet is immutable historical Phase 0 evidence. It must not
become a production dependency, public API, runtime fallback, or Phase 1 scaffold.
Phase 1 architecture checks enforce the frozen upstream identities and hashes but do not
inherit GitHub workflow, job, or artifact-authentication logic from this probe.
