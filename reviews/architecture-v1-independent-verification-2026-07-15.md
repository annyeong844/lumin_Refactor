...
Status: static-packaging closure independently passed; two Phase 0 evidence gates pending
...
and closed NEW-STATIC-PACKAGING-01. The remaining Phase 0 blockers are limited to
...
1. Reproduce every pinned upstream source/tarball/artifact SHA-256 in a clean standalone provenance-verifier/probe environment; Phase 1 architecture-check must later enforce the same pinned identities.
