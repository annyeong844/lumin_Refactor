...
| --- | ---: | ---: | ---: | --- |
| Standard | 86 | 84 | 2 | Focused `gate-immutable-opening-delta`: 1 passed, 0 failed; `corpus::tests::mode_counts`: 84 mapped, 2 unmapped. |
| Determinism | 86 | 84 | 2 | The same focused row passed with 7 semantic captures; `corpus::tests::mode_counts`: 84 mapped, 2 unmapped. |
...
| **Total execution obligations** | **183** | **177** | **6** | This total deliberately counts each required lane execution. |
