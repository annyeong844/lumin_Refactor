...
| Determinism | 86 | 63 | 23 | Focused `corpus::tests::mode_counts`: 63 mapped, 23 unmapped; `nearest-manifest`: 2 invocations passed with 29 semantic captures, 0 failed. Last required public CI mapped aggregate: 59 passed, 0 failed. |
