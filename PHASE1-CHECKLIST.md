...
| --- | ---: | ---: | ---: | --- |
| Standard | 86 | 70 | 16 | Focused `corpus::tests::mode_counts`: 70 mapped, 16 unmapped; `mixed-vue-gate`: 1 passed, 0 failed. |
| Determinism | 86 | 70 | 16 | Focused `corpus::tests::mode_counts`: 70 mapped, 16 unmapped; `mixed-vue-gate`: 2 variants passed, 0 failed. |
