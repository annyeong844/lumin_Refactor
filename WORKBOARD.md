...
| REVIEW-003 | reopened | `reviews/dependency-edge-identity-amendment-2026-08-10.md` | Owns the exact dependency-surface policy identity, isolated Cargo bootstrap, and loaded-source provenance boundary. |
