...
| REVIEW-004 | review candidate | `reviews/cache-cleanup-protocol-amendment-2026-08-17.md` | Owns the cache-cleanup command contract and identity-bound deletion amendment; implementation remains blocked until independent review passes. |
