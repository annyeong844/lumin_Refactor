...
| REVIEW-004 | review candidate | `reviews/cache-cleanup-protocol-amendment-2026-08-17.md` | Owns ARCH-000 cache-command registration and the manifest-bound active-cache eviction amendment; implementation remains blocked until independent review passes. |
