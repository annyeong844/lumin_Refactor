...
6. **Durable pre/post:** Pre-write returns a gate ID and post-write requires that exact ID. Do not create intent JSON or transport files. Block write/write and write/semantic-read conflicts, and release every lock before result transport.
